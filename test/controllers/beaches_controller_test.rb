...
class BeachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beach" do
    assert_difference('Beach.count') do
      post beaches_url, params: { beach: { country: @beach.country, name: @beach.name } }, as: :json
    end
  ...
  test "should update beach" do
    patch beach_url(@beach), params: { beach: { country: @beach.country, name: @beach.name } }, as: :json
    assert_response 200
  end
